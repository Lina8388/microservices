...
class ParameterServiceImplTest {
    ...
    @Test
    void canGetParameterByParameterNameBySystemName() {
        //  Given
        Parameter bdParam1 = Parameter.builder()
                .id(1L)
                .parameterName("TestParam1")
        ...
        SupParameterDto defaultParam = SupParameterDto.builder()
                .parameterName(bdParam1.getParameterName())
                .parameterValue(bdParam1.getParameterValue().get(0))
                .parameterType(bdParam1.getParameterType())
                .isList(bdParam1.getIsList())
                .systemName(bdParam1.getSystemName())
                .updateTime(bdParam1.getUpdateDate())
                .build();
        doReturn(bdParam1).when(parameterRepository)
                .getParameterByParameterNameBySystemName(bdParam1.getParameterName(), bdParam1.getSystemName());

        // When Then
        assertThat(underTest.getParameterByParameterNameBySystemName(bdParam1.getParameterName(), bdParam1.getSystemName())).isEqualTo(defaultParam);
